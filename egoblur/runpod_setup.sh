#!/usr/bin/env bash
# Idempotent RunPod setup for egoblur/job.py.
#
...
#     bash /workspace/egoannote/egoblur/runpod_setup.sh
...
cat > "$ENV_FILE" <<EOF
# Generated by egoblur/runpod_setup.sh — source this in every new shell:
